  ...
  return (
    <div>
      <div className="py-24 sm:py-32">
        ...
        <p className="mx-auto mt-6 max-w-2x px-10 text-center text-lg leading-8 text-gray-600">
          Choose an affordable plan thats packed with the best features for interacting with your
          PDFs, enhancing productivity, and streamlining your workflow.
        </p>
        <div className="max-w-md mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 md:max-w-2xl gap-8 lg:max-w-4xl ">
          ...
          <div className="ring-1 ring-gray-200 p-8 h-fit pb-12 rounded-3xl">
            ...
            <ul role="list" className="mt-8 space-y-3 text-sm leading-6 text-gray-600">
              <li className="flex gap-x-3">
                <CheckIcon className="h-6 w-5 flex-none text-violet-600" />2 Documents
              </li>
              <li className="flex gap-x-3">
          ...
          {/**PRO */}
          <div className="ring-2 ring-violet-600 rounded-3xl p-8">
            <h3 className="text-lg font-semibold leading-8 text-violet-600">Pro Plan</h3>
            ...
            <Button
              className="bg-violet-600 w-full text-white shadow-sm hover:bg-violet-500 mt-6 block rounded-md px-3 py-2 text-center text-sm font-semibold leading-6 focus-visible:otline focus-visible:otline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-600 "
