...
const features = [
  {
    ...
    description:
      'Kepp all your important PDF files securely stored and easily accessible anytime, anywhere.',
    icon: GlobeIcon,
  },
  {
...
export default function Home() {
  return (
    <main className="flex-1 overflow-scroll p-2 lg:p-5 bg-gradient-to-bl from-white to-violet-600">
        ...
        <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-700">
              Introducing <span className="font-bold text-violet-600">Chat with PDF.</span>
              <br />
              <br /> Upload your document, and our chatbot will answer questions, summarize content,
              and answer all your Qs. Ideal for everyone,{' '}
              <span className="text-violet-600">Chat with PDF</span>
